...
function PrevArrow(props) {
  ...
  return (
    <button
      onClick={onClick}
      className="absolute text-rose-400 !-left-5  text-2xl !top-[40%] z-30 w-8 h-20  md:-left-9 md:top-[40%] hidden md:block"
    >
...
function NextArrow(props) {
  ...
  return (
    <button
      onClick={onClick}
      className="absolute text-rose-400  text-2xl !top-[40%] !-right-7  z-30 w-8 h-20 md:-right-9 md:top-[40%] hidden md:block "
    >
          ...
          <div className="slider-container  border   mx-auto mt-2 rounded-md flex  ">
           ...
           "
                >
                  ...
                  <div className="absolute top-0 ">{shaquib.favourite}</div>
                  <div className="text-sm font-semibold mt-2 ml-2">
                    {shaquib.description}
                  </div>
                  <div className="text-sm font-semibold mt-1 ml-2 text-green-500">

...
const inner4 = [
  {
    ...
    thumbnail:
      "https://crazzyhub.s3.amazonaws.com/media/product_variant_image/New_Project_81_yS1VPaQ.jpg",
  },
  {
    id: 2,
    ...
    thumbnail:
      "https://crazzyhub.s3.amazonaws.com/media/product_variant_image/crazzyhub__image_9_Fq11emw_VyPF9Rw.jpg",
  },
  {
    id: 3,
    ...
    thumbnail:
      "https://crazzyhub.s3.amazonaws.com/media/product_variant_image/crazzyhub__image_10_fvvP8i6_oG7R12b.jpg",
  },
  {
    id: 4,
    ...
    thumbnail:
      "https://crazzyhub.s3.amazonaws.com/media/product_variant_image/crazzyhub__image_11_GKbqZwY_BmD6hXc.jpg",
  },
  {
    id: 5,
    title: "OPPO Reno12",
    ...
    thumbnail:
      "https://crazzyhub.s3.amazonaws.com/media/product_variant_image/crazzyhub__image_12_pnes0fW.jpg",
  },
  {
    id: 6,
    title: "OPPO Reno12",
    ...
    <div className="w-[100%]">
      ...
      <div className="flex  m-5 mb-5">
          ...
          <div className="w-[100%] mx-auto mt-2 flex justify-center gap-x-2">
            ...
            <div className="w-[80%] flex  gap-x-2">
              ...
              <div className="border-2">
                <img
                  src="https://crazzyhub.s3.amazonaws.com/media/product_variant_image/crazzyhub__image_9_Fq11emw_VyPF9Rw.jpg"
                  alt=""
                />
              </div>
              <div className="border-2">
                <img
                  src="https://crazzyhub.s3.amazonaws.com/media/product_variant_image/crazzyhub__image_10_fvvP8i6_oG7R12b.jpg"
                  alt=""
                />
              </div>
              <div className="border-2">
                <img
                  src="https://crazzyhub.s3.amazonaws.com/media/product_variant_image/crazzyhub__image_11_GKbqZwY_BmD6hXc.jpg"
                  alt=""
                />
              </div>
              <div className="border-2">
                <img
                  src="https://crazzyhub.s3.amazonaws.com/media/product_variant_image/crazzyhub__image_12_pnes0fW.jpg"
                  alt=""
                />
              </div>
        ...
        <div className="w-[37%] ">
          ...
          Party Speaker 500 W Bluetooth Party Speaker (Black)
          </div>
          ...
          <div className="flex ml-6 gap-x-3">
            <div className="text-orange-500 text-xl font-bold">₹17,999</div>

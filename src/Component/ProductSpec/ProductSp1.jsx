      ...
      <div className="flex  m-5 mb-5">
        <div className="w-[40%] ">
          ...
          <div className="w-[100%] mx-auto mt-2 flex justify-center gap-x-2">
            <div><IoIosArrowBack className="border rounded-full  text-3xl text-gray-500 mt-4 font-mono border-gray-500 pr-1"/></div>
            <div className="w-[80%]">
            <NewScroll />
            </div>
            <div><IoIosArrowForward className="border rounded-full  text-3xl text-gray-500 mt-4 font-mono border-gray-500 pl-1"/></div>
